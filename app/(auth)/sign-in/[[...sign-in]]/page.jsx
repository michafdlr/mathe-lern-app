          ...
          <div className="hidden lg:relative lg:block lg:p-12">
            <a className="block text-white" href="#">
              ...
              >
                ...
                <rect x="14.5" y="3" width="2" height="16" fill="currentColor"/>


                <text x="7" y="10" fontFamily="Arial" fontSize="10" fill="currentColor">+</text>
                <text x="20" y="10" fontFamily="Arial" fontSize="10" fill="currentColor">-</text>
                <text x="7" y="19" fontFamily="Arial" fontSize="10" fill="currentColor">×</text>
                <text x="19" y="19" fontFamily="Arial" fontSize="10" fill="currentColor">=</text>
              </svg>
            </a>
